...
class Ship extends SpriteComponent with TapCallbacks {
  late Vector2
      tujuan; //untuk menyimpan koordinat ketika kita mengklik/tap bagian dari layar, yang akan menjadi tujuan akhir dari ship
  late Vector2 arah;
  double speed = 3.0;
  ...
  Ship() {
    ...
    tujuan = position; //bergerk mengikuti arah gambar
  }
