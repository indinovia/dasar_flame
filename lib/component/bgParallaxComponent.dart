  ...
  Future<void> onLoad() async {
    parallax = await game.loadParallax(_parallelImage,
        baseVelocity: Vector2(0,
            -10), //jika yang depan -10, maka awan dan lain2 akan bergerak ke samping, jika yang di belakang -10 maka akan bergerak ke bawah
        velocityMultiplierDelta:
            Vector2(1, 1), //lebih smooth perubahan dari 1.5 menjadi 1
